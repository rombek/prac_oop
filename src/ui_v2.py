...
class Ui_SupermarketModelUI(object):
    ...
    def setupUi(self, window):
        ...
        self.left_line.setGeometry(QtCore.QRect(410, 0, 20, 800))
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 230, 410, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_13.setGeometry(QtCore.QRect(10, 320, 410, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, SupermarketModelUI):
        ...
        self.label_5.setText(_translate("SupermarketModelUI", "Промежуток между покупателями (мин.)"))
        ...
        self.label_10.setText(_translate("SupermarketModelUI", "Стоимость покупки (руб.)"))
        ...
        self.label_13.setText(_translate("SupermarketModelUI", "Время обслуживания одного покупателя (мин.)"))
        ...
        self.label_17.setText(_translate("SupermarketModelUI", "Зарплата кассира в день (т.р)"))  # TODO: добавить
